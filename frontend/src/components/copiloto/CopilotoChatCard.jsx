    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* ============================================================ */}
          <header className="flex shrink-0 items-center justify-between border-b border-brand-500/20 pb-3 pt-1">
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-brand-400/70 font-mono truncate flex items-center gap-1">
                  <Cpu className="w-3 h-3 text-brand-400 inline" />
          ...
          >
            {mensajes.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full text-center py-4 px-2 space-y-4">
                ...
                <div className="relative shrink-0 flex items-center justify-center p-2 rounded-full bg-transparent drop-shadow-[0_0_25px_rgba(78,124,190,0.8)] hover:scale-105 transition-transform duration-300">
          ...
          {/* ============================================================ */}
          <form onSubmit={onEnviar} className="flex shrink-0 items-center gap-2 pt-2 border-t border-brand-500/20">
            {vozSoportada && onMicrofono && (
              <button
                ...
                className={cn(
                  ...
                  escuchando ? 'text-red-400 border-red-500/50 shadow-[0_0_15px_rgba(239,68,68,0.4)] animate-pulse' : 'text-brand-300'
                )}
              >
