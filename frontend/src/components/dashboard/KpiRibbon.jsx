...
const TONO_RIBBON = {
  ...
  emerald: {
    bg: 'bg-accent-50/80 hover:bg-accent-100/80 border-accent-200/80 text-accent-700 dark:bg-accent-950/40 dark:hover:bg-accent-900/50 dark:border-accent-500/25 dark:text-accent-300',
    badge: 'bg-accent-500/10 text-accent-700 dark:bg-accent-500/20 dark:text-accent-200',
    dot: 'bg-accent-500 dark:bg-accent-400',
    iconBg: 'bg-accent-500/10 text-accent-600 dark:bg-black/30 dark:text-accent-300',
  },
  amber: {
    bg: 'bg-warn-50/80 hover:bg-warn-100/80 border-warn-200/80 text-warn-700 dark:bg-warn-950/40 dark:hover:bg-warn-900/50 dark:border-warn-500/25 dark:text-warn-300',
    badge: 'bg-warn-500/10 text-warn-700 dark:bg-warn-500/20 dark:text-warn-200',
    dot: 'bg-warn-500 dark:bg-warn-400',
    iconBg: 'bg-warn-500/10 text-warn-600 dark:bg-black/30 dark:text-warn-300',
  },
  rose: {
